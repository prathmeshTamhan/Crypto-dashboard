        ...
        >
          <div className="container-fluid">
            ...
            >
              ...
              <option value="digifinex">Digifinix (DIF)</option>
              <option value="bitcoin">Coinbase Exchange(CBE)</option>
              <option value="Tidex">Tidex(TX)</option>
              <option value="Coinsbit">CoinsBit(CSB)</option>
              <option value="cointiger">CoinTiger(ct)</option>
            </select>
